...
void acmi::createHeader()
{
    ...
    sprintf_s(header, sizeof(header), headerTemplate, fileType, fileVersion, year, month, day, hour, min, secBuff, dataSource, dataRecorder, author, title, comments, latBuff, lonBuff);
}
